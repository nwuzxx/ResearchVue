        ...
        <el-form  :model="paperList" label-width="80px">
           ...
           <!-- <el-form-item label="文章类型">
            ...
            <el-form-item label="会议名称">
                <el-input style="width: 95%" v-model="paperList.conferenceName" placeholder="请输入会议名称"></el-input>
            </el-form-item>

            <el-form-item label="会议语言">
  ...
  export default{
    ...
    created(){
      ...
      if(this.$route.params  && this.$route.params.id){
        ...
        this.getConferencePaperInform(id)
      }

    },
    methods:{
      //根据id查询
      getConferencePaperInform(paper_id){
        paper.getConferencePaperId(paper_id) 
          .then(response => {
      ...
      //添加
      save(){
        paper.addConferencePaper(this.paperList)
          .then(respense => {
            //提示信息
             this.$message({
              type: 'success',
            ...
            //跳转回列表页面
            this.$router.push({path:'/research/paper/conference/list'})
          })
      },
      //修改
      update(){
        paper.updateConferencePaper(this.paperList)
          .then(respense => {
            //提示信息
             this.$message({
              type: 'success',
