<template>
  <div style="padding:30px;">
    <el-form :inline="true" :model="searchObj" class="demo-form-inline" ref="searchObj">
      <el-form-item prop="paper_name" label="论文题目">
        <el-input v-model="searchObj.paper_name" placeholder="论文名称"></el-input>
      </el-form-item>
       <el-form-item prop="periodical_name" label="期刊名称">
        <el-input v-model="searchObj.periodical_name" placeholder="期刊名称"></el-input>
      </el-form-item>
...
export default{
  ...
  methods: {
    ...
    getList(page = 1){
      this.current = page
      // alert(this.searchObj.paperName)
